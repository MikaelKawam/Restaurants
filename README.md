# The Restaurants API: This .NET 8.0 web API is developed for managing restaurants, following the principles of Clean Architecture in detail, and integrating with Azure Services.
